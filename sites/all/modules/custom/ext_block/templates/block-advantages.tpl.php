  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="section-title">
        <div><?php print t('Modern production facility'); ?></div>
      </div>
    </div>
  </div>
        ...
        <div class="col-xs-12 col-md-4 col-no-gutter">
          <div class="row row-no-gutter">
            ...
            <div class="col-xs-12 col-no-gutter">
              <div class="b22">
                <div>
                  <?php print t("The plant successfully passes annual audits organized by international companies in various areas."); ?>
                </div>
              </div>
            </div>
          </div>
