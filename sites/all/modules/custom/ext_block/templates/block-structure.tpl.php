...
<div class="block-structure">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="section-title">
        <div><?php print t('KCCC GROUP structure'); ?></div>
      </div>
    </div>
  </div>
  ...
  <div class="row center-xs">
    <div class="col-xs-12 col-md-4">
      <a href="https://joy-magazin.ru" target="_blank">
        <div class="division hover-raise">
          <div class="logo"><img src="/sites/all/modules/custom/ext_block/images/logo-strada.png" alt=""></div>
    ...
    <div class="col-xs-12 col-md-4">
      <a href="https://smola.kccc.ru" target="_blank">
        <div class="division hover-raise">
          <div class="logo"><img src="/sites/all/modules/custom/ext_block/images/logo-smola.png" alt=""></div>
